...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        // Create Companies
        const company1 = yield prisma.company.create({
            data: {
                name: 'LTI',
            },
        });
        // Create Interview Flows
        const interviewFlow1 = yield prisma.interviewFlow.create({
            data: {
                description: 'Standard development interview process',
            },
        });
        const interviewFlow2 = yield prisma.interviewFlow.create({
            data: {
                description: 'Data science interview process',
            },
        });
        // Create Positions
        const position1 = yield prisma.position.create({
            data: {
        ...
        const position2 = yield prisma.position.create({
            data: {
        ...
        // Create Candidates
        const candidate1 = yield prisma.candidate.create({
            data: {
                firstName: 'John',
                lastName: 'Doe',
        ...
        const candidate2 = yield prisma.candidate.create({
            data: {
                firstName: 'Jane',
                lastName: 'Smith',
        ...
        const candidate3 = yield prisma.candidate.create({
            data: {
                firstName: 'Carlos',
                lastName: 'García',
        ...
        const interviewType1 = yield prisma.interviewType.create({
            data: {
                name: 'HR Interview',
                description: 'Assess overall fit, tech stack, salary range and availability',
            },
        });
        const interviewType2 = yield prisma.interviewType.create({
            data: {
                name: 'Technical Interview',
                description: 'Assess technical skills',
            },
        });
        const interviewType3 = yield prisma.interviewType.create({
            data: {
        ...
        const interviewStep1 = yield prisma.interviewStep.create({
            data: {
                interviewFlowId: interviewFlow1.id,
        ...
        const interviewStep2 = yield prisma.interviewStep.create({
            data: {
                interviewFlowId: interviewFlow1.id,
        ...
        const interviewStep3 = yield prisma.interviewStep.create({
            data: {
                interviewFlowId: interviewFlow1.id,
        ...
        // Create Applications
        const application1 = yield prisma.application.create({
            data: {
        ...
        const application2 = yield prisma.application.create({
            data: {
        ...
        const application3 = yield prisma.application.create({
            data: {
                positionId: position1.id,
        ...
        const application4 = yield prisma.application.create({
            data: {
                positionId: position1.id,
