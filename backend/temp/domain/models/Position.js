...
class Position {
    ...
    static async findActivePositions(page = 1, limit = 10) {
     ...
     */
    static async getKanbanData(positionId) {
        ...
        // 3. Crear columna "Aplicación" (siempre primera)
        ...
        for (const app of applications) {
            ...
            if (!lastInterview) {
                // Candidato sin entrevistas va a "Aplicación"
                ...
                if (targetColumn) {
                    ...
                    // Fallback: si no encuentra la columna, va a "Aplicación"
                    applicationColumn.candidates.push(candidateData);
                }
            }
        }
     ...
     */
    static async validateInterviewFlow(positionId) {
