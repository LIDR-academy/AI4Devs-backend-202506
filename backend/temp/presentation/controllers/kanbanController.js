...
exports.validateKanbanAccess = exports.checkKanbanHealth = exports.getPositionInterviewSteps = exports.getPositionKanbanStatistics = exports.getPositionKanban = void 0;
const kanbanService_1 = require("../../application/services/kanbanService");
/**
 ...
 */
const getPositionKanban = async (req, res) => {
    try {
        // 1. Validar parámetros de entrada
        const positionIdParam = req.params.id;
        const validation = (0, kanbanService_1.validateKanbanRequest)(positionIdParam);
        ...
        const kanbanData = await (0, kanbanService_1.getKanbanData)(positionId);
        // 4. Formatear respuesta exitosa
        const formattedResponse = (0, kanbanService_1.formatKanbanResponse)(kanbanData);
        // 5. Log de éxito
        ...
        if (error instanceof Error) {
            const formattedError = (0, kanbanService_1.formatKanbanError)(error);
...
exports.getPositionKanban = getPositionKanban;
/**
 ...
 * }
 */
const getPositionKanbanStatistics = async (req, res) => {
    try {
        // 1. Validar parámetros de entrada
        const positionIdParam = req.params.id;
        const validation = (0, kanbanService_1.validateKanbanRequest)(positionIdParam);
        ...
        const statistics = await (0, kanbanService_1.getKanbanStatistics)(positionId);
        // 4. Log de éxito
...
exports.getPositionKanbanStatistics = getPositionKanbanStatistics;
/**
 ...
 * }
 */
const getPositionInterviewSteps = async (req, res) => {
    try {
        // 1. Validar parámetros de entrada
        const positionIdParam = req.params.id;
        const validation = (0, kanbanService_1.validateKanbanRequest)(positionIdParam);
        ...
        const interviewSteps = await (0, kanbanService_1.getInterviewStepsForPosition)(positionId);
        // 4. Log de éxito
...
exports.getPositionInterviewSteps = getPositionInterviewSteps;
/**
 ...
 * }
 */
const checkKanbanHealth = async (req, res) => {
    try {
        // 1. Validar parámetros de entrada
        const positionIdParam = req.params.id;
        const validation = (0, kanbanService_1.validateKanbanRequest)(positionIdParam);
...
exports.checkKanbanHealth = checkKanbanHealth;
/**
 ...
 */
const validateKanbanAccess = async (req, res, next) => {
    try {
...
exports.validateKanbanAccess = validateKanbanAccess;
